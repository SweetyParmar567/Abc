            ...
            <div class="col-8 offset-2 mt-5">
                <div class="card">
                    <div class="card-header bg-info">
                        <h3 class="text-white text-center">Create Data</h3>
                    </div>
                    <div class="card-body">
                        ...
                        {{-- <form method="POST" action="/Crud_AA" enctype="multipart/form-data"> --}}
                        ...
                        <form method="POST" action="{{ route('products.index') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-center">
                                <button class="btn btn-success btn-submit" name="submit">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
